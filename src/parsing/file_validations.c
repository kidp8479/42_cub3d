...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/27 13:58:21 by diade-so          #+#    #+#             */
/*   Updated: 2025/12/27 13:58:23 by diade-so         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
   ...
   * @note Final check uses (== 0) to check for string equality,
   * as is standard with strncmp
   */
